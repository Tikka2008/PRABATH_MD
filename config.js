...
module.exports = {
  ...
  sudo: process.env.SUDO || '94760235991',
  ...
  ownername:process.env.OWNER_NAME || 'Resandu',
  sessionName: process.env.SESSION_ID || 'PRABATH-MD~o7kDVJBD#k0Vn43EaLEHAbjU1mS9nUfyShafh5OlFBRoNhIhiafA',
